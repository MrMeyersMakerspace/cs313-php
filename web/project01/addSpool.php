    ...
    <div id="page-container">
        <div id="content-wrap">
            ...
            <form>
                ...
                Notes: <textarea rows="4" cols="50" placeholder="0.00" min="0" step="0.01" title="currency" name="notes" id="textBox" onfocus="removeText()">Enter any extra notes here.</textarea><br />
