...
<body>
    <div id="page-container">
        <div id="content-wrap">
            ...
            <?php
            if (isset($_GET['user'])) {
                $statement = $db->prepare('SELECT * FROM (((print_job pj INNER JOIN users u ON pj.user_id = u.user_id) INNER JOIN printer p ON pj.printer_id = p.printer_id) INNER JOIN filament_spool fs ON pj.spool_id = fs.spool_id) WHERE u.user_id = :user');
            ...
            if (isset($_GET['printer'])) {
                $statement = $db->prepare('SELECT * FROM (((print_job pj INNER JOIN users u ON pj.user_id = u.user_id) INNER JOIN printer p ON pj.printer_id = p.printer_id) INNER JOIN filament_spool fs ON pj.spool_id = fs.spool_id) WHERE p.printer_id = :printer');
